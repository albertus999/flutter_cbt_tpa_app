      ...
      body: ListView(
        ...
        children: [
          ...
          BlocConsumer<RegisterBloc, RegisterState>(             
            listener: (context, state) {                     //menjalankan bloc listener
              state.maybeWhen(
                orElse: () {},
                success: (state) {
                  ...
                  context.pushReplacement(const DashboardPage());     // redirect page ke dashboard page
                },
              );
            },
            builder: (context, state) {                 //menjalankan bloc builder
              return state.maybeWhen(
                ...
                loading: () {
                  return const Center(
                    child: CircularProgressIndicator(),   //menjalankan widget circular progress indikator
                  );
                },
              );
            },
